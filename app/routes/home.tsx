...
// Full updated version with ability to uncheck widgets from sidebar if already in category
...
//               + Add Widget
//             </button>
//             <button className="border px-3 py-1 rounded text-sm hover:bg-gray-50">Last 2 days ▼</button>
//           </div>
//         </div>
//       </header>

//       {showSidebar && (
//         <div className="fixed top-0 right-0 w-full sm:w-[400px] h-full bg-white shadow-lg z-50 transition-all ease-in-out duration-300">
...
//                 <button
//                   key={tab}
//                   className={`text-sm font-medium border-b-2 ${tab === activeTab ? 'border-blue-600 text-blue-600' : 'border-transparent text-gray-600'}`}
...
//                 <p className="text-gray-400 text-sm">No widgets available.</p>
//               )}
//             </div>
...
//               <button onClick={() => setShowSidebar(false)} className="border px-4 py-2 rounded text-sm">Cancel</button>
//               <button onClick={handleConfirmWidgets} className="bg-blue-600 text-white px-4 py-2 rounded text-sm">Confirm</button>
//             </div>
//           </div>
//         </div>
//       )}

//       <main className="max-w-7xl mx-auto px-4 py-6 space-y-8 overflow-y-auto">
//         {Object.keys(dashboardData).map((category) => (
//           <section key={category} className="bg-white rounded-lg shadow p-4 space-y-4">
//             <h2 className="text-lg font-semibold text-gray-700">{category}</h2>
//             <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
//               {filteredWidgets(category).map((widget) => (
//                 <div key={widget.id} className="relative bg-gray-50 shadow-sm rounded p-4 border min-h-[200px]">
//                   <button
...
//                     ✕
//                   </button>
//                   <h3 className="font-bold text-gray-800 text-sm mb-1">{widget.name}</h3>
//                   {renderGraph(widget)}
//                 </div>
//               ))}
//               <div
//                 onClick={() => setShowSidebar(true)}
//                 className="cursor-pointer border-2 border-dashed rounded p-4 flex items-center justify-center text-sm text-gray-400 min-h-[100px] hover:bg-gray-100"
//               >
//                 + Add Widget
//               </div>
//             </div>
